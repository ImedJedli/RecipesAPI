...
const routes = [
    {
        path: 'recipes',
        loadChildren: () => __webpack_require__.e(/*! import() */ "src_app_recipes_recipes_module_ts").then(__webpack_require__.bind(__webpack_require__, /*! ./recipes/recipes.module */ 7776)).then(m => m.RecipesPageModule)
    },
    {
        path: '',
        redirectTo: 'recipes',
